...
class MainActivity : AppCompatActivity() {
    ...
    private fun rollDice() {
        ...
        val luckyNumber = nrFaces
        when (diceRoll) {
            luckyNumber -> Toast.makeText(this, "YOU GOT THE LUCKY NUMBER!", Toast.LENGTH_SHORT).show()
            ...
            5 -> Toast.makeText(this, "Apologies! You rolled a 5. Try again!", Toast.LENGTH_SHORT).show()
            else -> Toast.makeText(this, "Crap! You rolled a ${diceRoll}. Try again!", Toast.LENGTH_SHORT).show()
        }
    }
}
